...
namespace IFSPLibrary.App.Base
{
    public partial class CadastroBase : MaterialForm
    {
        ...
        {
            if (MessageBox.Show(@"Deseja realmente cancelar?", @"IFSP Library", MessageBoxButtons.YesNo,
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(@"Deseja realmente deletar?", @"IFSP Library", MessageBoxButtons.YesNo,
                        MessageBoxIcon.Question)
                    == DialogResult.Yes)
                {
            ...
            {
                MessageBox.Show(@"Selecione algum registro!", @"IFSP Library", MessageBoxButtons.OK,
